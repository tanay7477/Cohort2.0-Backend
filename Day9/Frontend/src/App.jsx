...
function fetchNotes(){
axios.get('https://cohort2-0-backend-day9.onrender.com/api/notes')
  .then((res)=>{
...
useEffect(()=>{
  ...
  function handleSubmit(e){
    ...
    axios.post('https://cohort2-0-backend-day9.onrender.com/api/notes',{
       title:title.value ,
  ...
  axios.delete('https://cohort2-0-backend-day9.onrender.com/api/notes/'+noteId)
    .then( res=>{
      console.log(res.data)
  fetchNotes()
